...
Hi, I'm **Lucky July Twala**, an aspiring **Data Scientist** with a growing passion for using data to solve real-world financial problems. I am currently developing my skills in data analytics, machine learning, SQL, Python, Power BI, and Excel while studying ICT Application Development and the design thing & data science program(leanrership). My goal is to use data to uncover valuable insights, build model, improve financial processes, and help organisations make better decisions, data-driven decisions.
...
The role I am currently working towards is becoming a **Data Scientist**.

I chose this role because I enjoy analysing data, discovering patterns, and using technology to solve complex business problems. My interest in the finance industry has shown me how valuable data is for improving decision-making, reducing risks, and increasing efficiency. As I continue learning data science and gaining practical experience, I believe this role is the best path to combine my technical skills with my passion for solving meaningful business challenges.
